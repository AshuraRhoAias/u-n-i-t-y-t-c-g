...
namespace WaifuSummoner.Cards
{
    public enum Role
    {
        ...
        Aviatrix,     // Piloto aérea, planeadora, tecnología ligera y vuelo táctico
        Harpie,       // Mitad ave, alas en lugar de brazos o alas grandes; salvajes y veloces
        Vampiress     // Vampiro femenina, sensual, oscura, bebedora de sangre
    }
}